...
def main():
    ...
    pcdeqcSheet = client.open('pcdeqc_db').worksheet('pcdeqc_db')
    ...
    if recentDate != datetime.datetime.strftime(today - datetime.timedelta(1),'%Y-%m-%d'):
        ...
        for project in projectDict:
            returnedSamples.extend(getSamplesInLab(project, recentDate, projectDict))
...
def getSamplesInLab(project, date, projectDict):
    ...
    for record in results:
        ...
        if re.search('SCAN+',project):
            if zipcode in ['98101','98102','98103','98104','98105','98106','98107','98108',
                                '98109','98112','98115','98116','98117','98118','98119','98121','98122','98125','98126','98133',
                                '98134','98136','98144','98146','98154','98155','98164','98177','98178','98195','98199','98004',
                                '98005','98006','98007','98008','98033','98034','98039','98040','98056','98059','98011','98028',
                                '98001','98002','98003','98023','98030','98031','98032','98042','98047','98055','98057','98058',
                                '98148','98166','98168','98188','98198','98010','98022','98038','98045','98051','98065','98027',
                                '98029','98052','98074','98075','98092','98070','98014','98077','98053','98024','98072','98019']:
                row['project'] = 'SCAN King'
            elif zipcode in ['98409', '98406','98404','98402','98411','98413','98419','98418','98415','98401',
                                    '98405','98416','98417','98403','98388','98466','98303','98351','98464','98465','98333',
                                    '98349','98407','98335','98394','98395','98528','98332','98329','98431','98430','98439',
                                    '98327','98493','98438','98433','98496','98497','98498','98499','98467','98444','98446',
                                    '98445','98447','98448','98408','98391','98422','98352','98443','98390','98372','98354',
                                    '98424','98421','98375','98374','98371','98373','98580','98387','98397','98330','98398',
                                    '98304','98348','98558','98328','98344','98338','98323','98396','98360','98385','98321']:
...
def aggregate_data(returnedSamples, today):
    returnedSamples['date'] = pd.to_datetime(returnedSamples['date']).dt.strftime('%Y-%m-%d')
    #excludes today's samples since partial days would not be used in forecasting
    returnedSamples = returnedSamples[returnedSamples['date'] != today.strftime('%Y-%m-%d')]
    print('fetched '+str(len(returnedSamples.index))+' rows')
    table = returnedSamples.groupby(['date', 'project']
        ).agg({'project': 'count'})
    return table
...
def create_forecast(pcdeqcSheet, forecastSheet, today):
    ...
    pcdeqc = pcdeqc.groupby(['project','weekday']
        ).agg({'pcdeqc':'mean'})
    ...
    forecastSheet.insert_rows(forecastImport, next_available_row(forecastSheet), value_input_option='USER_ENTERED')
